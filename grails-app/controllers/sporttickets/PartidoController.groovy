...
class PartidoController {
    ...
    def save(Partido partidoInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'partidoInstance.label', default: 'Partido'), partidoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'partidoInstance.label', default: 'Partido'), params.id])
                redirect action: "index", method: "GET"
            }
